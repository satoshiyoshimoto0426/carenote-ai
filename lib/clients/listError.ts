 ...
 *     components/clients/ClientsContext.tsx（利用者の画面の一覧の表・A案 A5）が fetchClientList を通して読む
 *
 ...
 * 使う側: lib/clients/useClientList.ts・components/clients/ClientsContext.tsx。
 */
